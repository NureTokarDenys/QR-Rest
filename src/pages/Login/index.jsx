...
export default function Login() {
  ...
  useEffect(() => {
    if (isAuthenticated && user) navigate(staffHome(user.role), { replace: true });
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.actions}>
          ...
          <button className={styles.googleBtn} onClick={initiateGoogleOAuth}>
          ...
          <SecondaryButton
            label={t('guest_mode')}
            onClick={() => { loginAsGuest(); navigate('/menu'); }}
          />
        </div>

        <p className={styles.signupRow}>
          {t('no_account')}{' '}
          <Link to="/register" className={styles.signupLink}>{t('create_one')}</Link>
        </p>
